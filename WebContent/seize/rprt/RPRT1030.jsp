...
<cb:pageWrapper title="Coupon usage rate" id="RPRT1030" plugin="grid, datepicker" pageType="">
   ...
   <!--GridArea-->
	        ...
	        <table cellspacing="0" class="SrchTBL">
	            ...
	            <tbody> 
	                ...
	                <tr>                                     
	                    ...
	                    <td><input id="MKT_NO" type="number" style="width:100%; text-align: right;" value="" data-io="IO" maxlength="20" oninput="this.value=this.value.slice(0,this.maxLength)" data-valid="require;" class="point" /></td>
    ...
    <script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/seize/rprt/RPRT1030.js"></script>
    </jsp:attribute>
</cb:pageWrapper>
