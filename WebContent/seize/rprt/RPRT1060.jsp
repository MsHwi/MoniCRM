...
<cb:pageWrapper title="Usage Trend of Favorite Transaction" id="RPRT1060" plugin="grid, datepicker" pageType="">
    ...
    <script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/seize/rprt/RPRT1060.js"></script>
    </jsp:attribute>
</cb:pageWrapper>
