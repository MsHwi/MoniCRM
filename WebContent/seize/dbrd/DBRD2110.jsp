...
<cb:pageWrapper title="Usage Trend of Favorite Transaction" id="DBRD2110" plugin="datepicker, chart, grid" pageType="link">

    <jsp:attribute name="headWrapper" />
    <jsp:attribute name="bodyWrapper">

    <!--SearchArea-->
    <section id="DIV_SRCH2110" class="dashSrch" style="position:absolute; top:0px; left:0; right:0;">
	    <div class="SrchDiv">
	        <table cellspacing="0" class="SrchTBL">
                ...
                <tbody>    
                    <tr>
                        ...
                        <td><cbt:combo code="" name="AREA_INFO" id="CITY_CD" class="point" codeType="ONE" data-option="event:init;type:area-city;top:ALL;" data-parent="#DIV_SRCH2110 #AREA_CD" data-io="IO" style="width: 100%;" /></td>
    ...
    <!--//Chart Area -->
        ...
        <script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/seize/dbrd/DBRD2110.js"></script>        
